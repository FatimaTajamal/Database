...
console.log('DB Recipe Check:', {
  found: !!recipe,
  ingredientsCount: recipe?.ingredients?.length,
  instructionsCount: recipe?.instructions?.length
});

// ✅ ONLY return if recipe is complete
if (isValidRecipe) {
  console.log('✅ Serving recipe from MongoDB:', recipe.title || recipe.name);
  return res.json({
...
// ❌ FALLBACK → Gemini
console.log('⚡ Recipe not found or incomplete — calling Gemini API...');
